  ...
  return (
    ...
    <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        <div className="font-light text-gray-500 sm:text-lg ">
            ...
            <p className="mb-4">WAre you seeking comprehensive immigration and recruitment services? Look no further! At Litha@Work, we specialize in offering expert consultancy for all matters related to immigration in the Republic of South Africa, covering various types of visas.</p>
