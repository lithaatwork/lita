  ...
  return (
    ...
    <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        <div className="font-light text-gray-500 sm:text-lg ">
            ...
            <p>We are committed to providing you with top-notch  guidance throughout the immigration process. Our dedicated team ensures the dispensation of accurate and reliable information to help you achieve your immigration goals seamlessly.</p>
        </div>
